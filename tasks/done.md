...
- [x] Design exploration (experiment) — completed: 2026-04-01 — built first-screen prototype (Size panel with 3D SVG mattress) and design system documentation page; migrated to Tailwind CSS; archived in /archive/experiment/
